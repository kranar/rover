...
IF NOT EXIST "!DIRECTORY!Libraries\!CONFIG!\rover.pyd" (
  ECHO Error: Source file "!DIRECTORY!Libraries\!CONFIG!\rover.pyd" not found.
  EXIT /B 1
)
COPY /Y "!DIRECTORY!Libraries\!CONFIG!\rover.pyd" "!PYTHON_PATH!\" >NUL
IF ERRORLEVEL 1 (
  ECHO Error: Failed to copy "rover.pyd" to "!PYTHON_PATH!".
  EXIT /B 1
)
EXIT /B 0
ENDLOCAL
